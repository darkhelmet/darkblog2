(function() {
  (function($) {
    ...
    return ($.fn.embedly = function(options) {
      ...
      elems = [];
      this.each(function() {
        return this.href && settings.urlRe.test(this.href) ? elems.push({
          url: this.href,
          node: $(this)
        }) : null;
      });
      processBatch = function(batch) {
        ...
        embed = function(oembed, dict) {
          ...
          if (settings.wrapElement) {
            code = code.wrap(settings.wrapElement);
          }
          oembed.code = code;
      ...
      _result = []; _ref = elems.length;
      for (i = 0; (0 <= _ref ? i < _ref : i > _ref); i += 20) {
        _result.push(processBatch(elems.slice(i, i + 20)));
      }
      return _result;
    });
  })(jQuery);
