(function() {
  (function($) {
    ...
    return $.fn.embedly = function(options) {
      var elems, i, processBatch, settings, _ref, _results, _step;
      settings = $.extend({
        method: 'replace',
        addImageStyles: true,
        wrapElement: $('<div />'),
      ...
      _results = [];
      for (i = 0, _ref = elems.length, _step = 20; 0 <= _ref ? i < _ref : i > _ref; i += _step) {
        _results.push(processBatch(elems.slice(i, i + 20)));
      }
      return _results;
    };
  })(jQuery);
